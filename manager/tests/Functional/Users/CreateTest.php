...
class CreateTest extends DbWebTestCase
{
    ...
    public function testNotValid(): void
    {
        ...
        $this->assertContains('This value should not be blank.',
            $crawler->filter('#form_firstName')->parents()->first()->filter('.form-error-message')->text());

        $this->assertContains('This value should not be blank.',
            $crawler->filter('#form_lastName')->parents()->first()->filter('.form-error-message')->text());
    ...
    public function testExists(): void
    {
        ...
        $this->assertContains('User with this email already exists.',
